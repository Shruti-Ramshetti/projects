                ...
                products.map((item,index)=>{
                    return(
                       <div key={index} className="card">
                            ...
                            <pre className='productprice1'>offerPrice:{item.offerPrice}   <strike>{item.offerPrice}</strike></pre>
                            <pre className='productprice2'>originalPrice:{item.originalPrice}   <strike>{item.offerPrice}</strike></pre>
                            {
